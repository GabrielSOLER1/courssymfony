...
final class TopicController extends AbstractController
{
    ...
    #[Route('/{id}/post/new', name: 'app_topic_post_new', methods: ['GET', 'POST'])]
    public function newPost(Request $request, EntityManagerInterface $entityManager, Topic $topic): Response
    {
        $post = new Post();
        $post
            ->setTopic($topic)
